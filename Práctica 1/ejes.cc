...
void Ejes::createArrayData()
{
	...
	/*
	colorArray[0]  = 0.756; colorArray[1]  = 0.286; colorArray[2]  = 0.325;	// Rojo
	colorArray[3]  = 0.756; colorArray[4]  = 0.286; colorArray[5]  = 0.325;
	colorArray[6]  = 0.286; colorArray[7]  = 0.518; colorArray[8]  = 0.404; // Verde
	colorArray[9]  = 0.286; colorArray[10] = 0.518; colorArray[11] = 0.404;
	colorArray[12] = 0.443; colorArray[13] = 0.572; colorArray[14] = 0.745; // Azul
	colorArray[15] = 0.443; colorArray[16] = 0.572; colorArray[17] = 0.745;
	*/

	colorArray[0]  = 255/255.0; colorArray[1]  = 175/255.0; colorArray[2]  = 135/255.0;	// Clarito
	colorArray[3]  = 255/255.0; colorArray[4]  = 175/255.0; colorArray[5]  = 135/255.0;	
	colorArray[6]  = 255/255.0; colorArray[7]  = 142/255.0; colorArray[8]  = 114/255.0;	// Medio
	colorArray[9]  = 255/255.0; colorArray[10] = 142/255.0; colorArray[11] =  94/255.0;	
	colorArray[12] = 237/255.0; colorArray[13] = 106/255.0; colorArray[14] = 114/255.0; // Oscuro		
