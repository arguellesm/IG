...
public:
	...
	ObjRevolucion();
   	ObjRevolucion(const std::string & archivo, int num_instancias, bool tapa_sup=true, bool tapa_inf=true, char eje_r='Y', bool textura=false);
   	ObjRevolucion(std::vector<Tupla3f> archivo, int num_instancias, bool tapa_sup=true, bool tapa_inf=true, char eje_r='Y', bool textura=false);
...
private:
	...
	void calcular_textura(std::vector<Tupla3f> archivo, int num_instancias);
};
